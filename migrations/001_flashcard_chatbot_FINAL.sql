-- ============================================================================
-- FLASHCARD CHATBOT SCHEMA EXTENSIONS - FINAL CORRECTED VERSION
...
DO $$ 
BEGIN
    ALTER TABLE flashcard_chat_history DROP CONSTRAINT IF EXISTS flashcard_chat_history_role_check;
...
DO $$ 
BEGIN
    ALTER TABLE flashcard_generation_jobs DROP CONSTRAINT IF EXISTS flashcard_generation_jobs_status_check;
...
-- ============================================================================
-- SECTION 5: CREATE flashcard_embeddings TABLE
-- ============================================================================
