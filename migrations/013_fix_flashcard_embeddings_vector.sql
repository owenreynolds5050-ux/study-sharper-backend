-- ============================================================================
-- FIX FLASHCARD_EMBEDDINGS TABLE - CONVERT TO PROPER PGVECTOR
-- ============================================================================
-- This migration fixes the flashcard_embeddings table to use proper vector type
...
BEGIN
    RAISE NOTICE '';
    RAISE NOTICE '========================================';
    RAISE NOTICE '✅ flashcard_embeddings table fixed!';
    RAISE NOTICE '========================================';
    RAISE NOTICE '';
    ...
    RAISE NOTICE '   when flashcards are edited or processed.';
    RAISE NOTICE '========================================';
END $$;
