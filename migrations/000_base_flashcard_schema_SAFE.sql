-- ============================================================================
-- BASE FLASHCARD SCHEMA - SAFE VERSION
-- Handles existing tables gracefully
-- ============================================================================

DO $$ 
BEGIN
    RAISE NOTICE '🚀 Starting flashcard schema setup...';
END $$;
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'flashcard_sets') THEN
        ...
        RAISE NOTICE '✅ Created table: flashcard_sets';
    ELSE
        RAISE NOTICE '⏭️  Table flashcard_sets already exists, skipping...';
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'flashcards') THEN
        ...
        RAISE NOTICE '✅ Created table: flashcards';
    ELSE
        RAISE NOTICE '⏭️  Table flashcards already exists, skipping...';
    END IF;
END $$;
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'flashcard_chat_history') THEN
        ...
        RAISE NOTICE '✅ Created table: flashcard_chat_history';
    ELSE
        RAISE NOTICE '⏭️  Table flashcard_chat_history already exists, skipping...';
    END IF;
END $$;
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'flashcard_generation_jobs') THEN
        ...
        RAISE NOTICE '✅ Created table: flashcard_generation_jobs';
    ELSE
        RAISE NOTICE '⏭️  Table flashcard_generation_jobs already exists, skipping...';
    END IF;
END $$;
...
BEGIN
    RAISE NOTICE '';
    RAISE NOTICE '========================================';
    RAISE NOTICE '✅ Flashcard schema setup complete!';
    RAISE NOTICE '========================================';
    RAISE NOTICE '';
    RAISE NOTICE 'Tables ready:';
    RAISE NOTICE '  ✓ flashcard_sets';
    RAISE NOTICE '  ✓ flashcards';
    RAISE NOTICE '  ✓ flashcard_chat_history';
    RAISE NOTICE '  ✓ flashcard_generation_jobs';
    RAISE NOTICE '';
    RAISE NOTICE 'Functions created:';
    RAISE NOTICE '  ✓ update_flashcard_set_total_cards()';
    RAISE NOTICE '  ✓ get_suggested_flashcard_sets()';
    RAISE NOTICE '';
    RAISE NOTICE '🎉 You can now use flashcard features!';
    RAISE NOTICE '========================================';
END $$;
